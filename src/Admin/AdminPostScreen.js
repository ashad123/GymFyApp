    ...
    <View style={{ backgroundColor: "#e1e1e8", flex: 1 }}>
      ...
      <View style={styles.userheadertitle}>
        <Text style={styles.userheadertitleContent}>
          Workout Everyday Shape Your</Text>
          <Text style={styles.userheadertitleContent}>
           Body With GymiFy!{" "}
        </Text>
        <Text style={styles.userheadertitleContent1}>
          lorem ipsum dolor sit amet adipiscing a elit</Text>
          <Text style={styles.userheadertitleContent1}>
      ...
      <View style={styles.addCommentcontainer}>
        <TextInput placeholder="Add Comments" style={styles.addcommentinput} />
        <TouchableOpacity
          style={styles.btn}
...
sit a Porttitor suspendisse cursus diam a sit
sit a Porttitor suspendisse cursus diam a sit egestas euismod vitae a condimentum vita arcu justo adipiscing.
        </Text>
