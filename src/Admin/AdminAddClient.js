...
const AdminAddClient = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.headerContent}>Add Clients</Text>
      <EvilIcons
        name="user"
        size={70}
        color="black"
      ...
      <View style={styles.inputWrapper}>
        ...
        <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('Admin Leads')}>
