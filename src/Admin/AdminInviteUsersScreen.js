...
const AdminInviteUsersScreen = ({navigation}) => {
    return (
        <View style={{}}>
        ...
        <Text style={styles.btnContent}>Invite</Text>
      </TouchableOpacity>
            ...
            <View style={styles.card}>
              ...
              <TouchableOpacity style={[styles.btn, {backgroundColor: '#53C1FE'}]} >
        <Text style={[styles.btnContent, {color: '#fff'}]}>Invite</Text>
      </TouchableOpacity>
            </View>
...
export default AdminInviteUsersScreen