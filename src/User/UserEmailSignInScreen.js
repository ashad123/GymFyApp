...
const UserEmailSignInScreen = ({navigation}) => {
  const [isPressed, setIsPressed] = useState(false);

  const handlePress = () => {
    setIsPressed(true);
    // Add any other logic you want to perform when the TouchableOpacity is pressed
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <View style={styles.containerEmail}>
          <Text style={styles.textEmail}>Email Id</Text>
          <TextInput style={styles.inputEmail} placeholder="alexneo@gmail.com" />
        </View>
...
export default UserEmailSignInScreen